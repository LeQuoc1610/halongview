          ...
          <div className="row align-items-center g-5">
            ...
            <div className="col-lg-6">
              ...
              <p className="section-description">
                Sở hữu vị trí đắc địa tọa lạc tại Phố Hồng Tiến, Phường Trần
                Hưng Đạo, TP Hạ Long, Tỉnh Quảng Ninh, sở hữu hạ tầng và tiện
                ích đồng bộ và một cộng đồng dân cư văn minh và phát triển.
              </p>
              ...
              <p className="section-description">
                ...
                view tuyệt đẹp, tầm nhìn không giới hạn: Công viên Ha Long, Hồ
                Yết Kiêu, Công viên Đại Dương, Vịnh Ha Long...
              </p>
